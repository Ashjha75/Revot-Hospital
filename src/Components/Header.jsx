...
const Header = () => {
  ...
  return (
    <>
      <div className="w-[100vw] h-14 bg-[#37a4b9] flex absolute top-0 items-center  z-10 md:h-14">
        <Link>
        ...
        <div className="absolute right-4 md:right-9 flex">
          <Link>
            <button className="px-3 py-2 rounded-lg text-white bg-blue-600 hover:bg-blue-700 flex">
      ...
      {/* second Header */}
      <div className="w-[100vw] h-24 bg-[#37a4b9] fixed -bottom-7 flex justify-around items-center  md:top-14 z-50 md:h-10 md:justify-end md:space-x-8 md:pr-7 md:w-[59vw] md:right-0 md:rounded-b-full md:mb-1 md:absolute">

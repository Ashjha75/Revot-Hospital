...
const Menu = () => {
  ...
  return (
    <motion.div
      className="w-[100vw]  pt-12 md:pt-20 overflow-hidden"
      initial={{ width: 0 }}
      animate={{ width: "100%" }}
    ...
    >
      <div className=" h-fit  pt-16  flex flex-col md:flex-row justify-around items-center border-b-2  border-[#f4c3c3] rounded-lg shadow-sm  gap-5">
        ...
        <div className="w-[85%] h-fit  md:h-[55%] md:w-[55%] bg-[#f3f3f3]  border rounded-lg grid grid-flow-col grid-rows-4 sm:grid-rows-2  gap-3 p-5 overflow-x-scroll">
          <span className="bg-white w-52  px-5 md:px-7 py-5 border rounded-md  shadow-lg transform translate duration-500 hover:-translate-y-3 hover:scale-105 hover:border-slate-400">
            <h5 className="text-lg text-[#333]">Gender</h5>
            <p className="text-slate-400">{profileValues.Gender}</p>
          </span>
          <span className="bg-white w-52 px-7 py-3 border rounded-md  shadow-lg transform translate duration-500 hover:-translate-y-3 hover:scale-105 hover:border-slate-400">
            <h5>Phone</h5>
            <p className="text-slate-400">{profileValues.Phone}</p>
          </span>

          <span className="bg-white w-52 px-3 md:px-7 py-5 border rounded-md  shadow-lg transform translate duration-500 hover:-translate-y-3 hover:scale-105 hover:border-slate-400">
